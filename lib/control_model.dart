...
//
//     final controlsModel = controlsModelFromJson(jsonString);

import 'dart:convert';

ControlsModel controlsModelFromJson(String str) => ControlsModel.fromJson(json.decode(str));
...
class Form {
  ...
  factory Form.fromJson(Map<String, dynamic> json) => Form(
        id: json["id"],
        header: json["header"],
        controls: List<Control>.from(json["controls"].map((x) => Control.fromJson(x))),
      );
...
class Control {
  ...
  factory Control.fromJson(Map<String, dynamic> json) => Control(
        ...
        selectedValues: json["selectedValues"] == null ? [] : List<String>.from(json["selectedValues"].map((x) => x)),
      );
